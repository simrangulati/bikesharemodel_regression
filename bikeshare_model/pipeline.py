...
bikeCountPipeline=Pipeline([
    ...
    ('weathersit_imputer',WeathersitImputer(variable= config.model_config.weathersit_var)),
    ##==========Mapper======##
    ...
    ('weekDayOneHotEncoding',WeekdayOneHotEncoder(config.model_config.weekday_var)),
